...
export default class http {
  static async request(method, url, data, loading = true) {
    ...
    // param.header = Object.assign({}, param.header, {'Current-business': wepy.getStorageSync('businessCircleId') || 1})
    param.header = Object.assign({}, param.header, {'Current-business': 8})
    if (loading) {
      Tips.loading()
    }
